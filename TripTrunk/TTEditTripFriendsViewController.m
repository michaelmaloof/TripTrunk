...
- (void)saveFriendsAndClose
{
    ...
    /*
     TODO: Add Delegate Stuff Back
     8/10/2016 - mattschoch
     In changing this cloud function, I removed the delegate calls saying that the current user has been added.
     That was previously happening in a loop that called the cloud function, but now we pass the whole array into the function.
     
     The delegate needs to be notified that ALL of the users are added to the trunk, so it should update the UI accordingly.
     NOTE: This should happen here and in the AddTripFriendsViewController, since both are identical functions at the moment.
     */
